GO
IF EXISTS (SELECT Top 1 1 FROM sys.objects WHERE type = 'P' AND name = 'usp_Info_TransaccionVisaNet_Grabar')
	BEGIN
		DROP PROCEDURE usp_Info_TransaccionVisaNet_Grabar
	End
GO
GO
Create Procedure usp_Info_TransaccionVisaNet_Grabar
@Id_WebOrders			int,
@Nro_Orden				Int,
