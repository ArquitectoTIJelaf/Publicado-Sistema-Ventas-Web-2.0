GO
IF EXISTS (SELECT Top 1 1 FROM sys.objects WHERE type = 'P' AND name = 'usp_Tb_Cliente_Pasajes_ModificarPasajero')
	BEGIN
		DROP PROCEDURE usp_Tb_Cliente_Pasajes_ModificarPasajero
	End
GO
GO
Create Procedure usp_Tb_Cliente_Pasajes_ModificarPasajero    
@Tipo_Doc  Varchar(2),    
@DNI   Varchar(15),    
@Nombre   Varchar(100),    
