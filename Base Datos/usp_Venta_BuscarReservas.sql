GO
IF EXISTS (SELECT Top 1 1 FROM sys.objects WHERE type = 'P' AND name = 'usp_Venta_BuscarReservas')
	BEGIN
		DROP PROCEDURE usp_Venta_BuscarReservas
	End
GO
GO
Create Procedure usp_Venta_BuscarReservas
@Id_WebOrders		Int
as
Select 
vw.Id_VentaWeb,
...
Where vw.Id_WebOrders=@Id_WebOrders and v.INDI_ANULADO='F'
and v.Flag_Venta='R'