GO
IF EXISTS (SELECT Top 1 1 FROM sys.objects WHERE type = 'P' AND name = 'usp_VentaWeb_DetalleVentaxViajeCancelado')
	BEGIN
		DROP PROCEDURE usp_VentaWeb_DetalleVentaxViajeCancelado
	End
GO
GO
Create Procedure usp_VentaWeb_DetalleVentaxViajeCancelado 
@Id_VentaWeb		int
as
...
Inner Join Venta v on vw.Id_VentaWeb=v.Id_ventaWeb  and v.Indi_Anulado='T'
