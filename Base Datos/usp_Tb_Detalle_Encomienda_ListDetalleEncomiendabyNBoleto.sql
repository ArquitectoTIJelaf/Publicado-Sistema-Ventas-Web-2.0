GO
IF EXISTS (SELECT Top 1 1 FROM sys.objects WHERE type = 'P' AND name = 'usp_Tb_Detalle_Encomienda_ListDetalleEncomiendabyNBoleto')
	BEGIN
		DROP PROCEDURE usp_Tb_Detalle_Encomienda_ListDetalleEncomiendabyNBoleto
	End
GO
GO
Create Procedure usp_Tb_Detalle_Encomienda_ListDetalleEncomiendabyNBoleto 
