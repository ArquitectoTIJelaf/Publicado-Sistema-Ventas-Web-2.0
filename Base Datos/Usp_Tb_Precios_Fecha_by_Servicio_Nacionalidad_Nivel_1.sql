GO
IF EXISTS (SELECT Top 1 1 FROM sys.objects WHERE type = 'P' AND name = 'Usp_Tb_Precios_Fecha_by_Servicio_Nacionalidad_Nivel_1')
	BEGIN
		DROP PROCEDURE Usp_Tb_Precios_Fecha_by_Servicio_Nacionalidad_Nivel_1
	End
GO
GO
Create procedure [dbo].[Usp_Tb_Precios_Fecha_by_Servicio_Nacionalidad_Nivel_1]   --1,2,'10:30PM','16/04/2018',2,1,'1'    
@Origen   int,      
@Destino  int,      
@Hora   varchar(10),      
@Fecha   smalldatetime,      
