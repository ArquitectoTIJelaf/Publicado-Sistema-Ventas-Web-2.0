GO
IF EXISTS (SELECT Top 1 1 FROM sys.objects WHERE type = 'P' AND name = 'usp_tb_ListarPuntosArribo')
	BEGIN
		DROP PROCEDURE usp_tb_ListarPuntosArribo
	End
GO
GO
Create Procedure usp_tb_ListarPuntosArribo    
@Ori int,      
@des int,      
@ser int,      
@emp int,      
