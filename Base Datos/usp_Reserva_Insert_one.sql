GO
IF EXISTS (SELECT Top 1 1 FROM sys.objects WHERE type = 'P' AND name = 'usp_Reserva_Insert_one')
	BEGIN
		DROP PROCEDURE usp_Reserva_Insert_one
	End
GO
GO
Create Procedure usp_Reserva_Insert_one
