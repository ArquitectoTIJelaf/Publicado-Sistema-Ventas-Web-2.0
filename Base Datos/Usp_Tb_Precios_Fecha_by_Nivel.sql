GO
IF EXISTS (SELECT Top 1 1 FROM sys.objects WHERE type = 'P' AND name = 'Usp_Tb_Precios_Fecha_by_Nivel')
	BEGIN
		DROP PROCEDURE Usp_Tb_Precios_Fecha_by_Nivel
	End
GO
GO
Create procedure Usp_Tb_Precios_Fecha_by_Nivel
@Origen			int,
@Destino		int,
@Hora			varchar(10),
@Fecha			smalldatetime,
