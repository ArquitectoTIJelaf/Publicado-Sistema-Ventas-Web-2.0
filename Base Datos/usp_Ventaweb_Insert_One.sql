GO
IF EXISTS (SELECT Top 1 1 FROM sys.objects WHERE type = 'P' AND name = 'usp_Ventaweb_Insert_One')
	BEGIN
		DROP PROCEDURE usp_Ventaweb_Insert_One
	End
GO
GO
Create Procedure [dbo].[usp_Ventaweb_Insert_One]
