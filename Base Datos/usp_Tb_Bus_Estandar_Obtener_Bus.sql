GO
IF EXISTS (SELECT Top 1 1 FROM sys.objects WHERE type = 'P' AND name = 'usp_Tb_Bus_Estandar_Obtener_Bus')
	BEGIN
		DROP PROCEDURE usp_Tb_Bus_Estandar_Obtener_Bus
	End
GO
GO
Create Procedure usp_Tb_Bus_Estandar_Obtener_Bus
