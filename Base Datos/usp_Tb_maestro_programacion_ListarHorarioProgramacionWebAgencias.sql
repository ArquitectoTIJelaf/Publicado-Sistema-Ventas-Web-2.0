GO
IF EXISTS (SELECT Top 1 1 FROM sys.objects WHERE type = 'P' AND name = 'usp_Tb_maestro_programacion_ListarHorarioProgramacionWebAgencias')
	BEGIN
		DROP PROCEDURE usp_Tb_maestro_programacion_ListarHorarioProgramacionWebAgencias
	End
GO
GO
Create Procedure usp_Tb_maestro_programacion_ListarHorarioProgramacionWebAgencias   
@Origen   int,  
@Destino  int,  
@Codi_Servicio int,  
@Empresa tinyint  
