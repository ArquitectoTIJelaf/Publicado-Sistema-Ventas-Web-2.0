GO
IF EXISTS (SELECT Top 1 1 FROM sys.objects WHERE type = 'P' AND name = 'usp_WebOrders_GenerarNumOrdenAgencias')
	BEGIN
		DROP PROCEDURE usp_WebOrders_GenerarNumOrdenAgencias
	End
GO
GO
