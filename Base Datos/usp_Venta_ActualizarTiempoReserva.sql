GO
IF EXISTS (SELECT Top 1 1 FROM sys.objects WHERE type = 'P' AND name = 'usp_Venta_ActualizarTiempoReserva')
	BEGIN
		DROP PROCEDURE usp_Venta_ActualizarTiempoReserva
	End
GO
GO
Create Procedure usp_Venta_ActualizarTiempoReserva
@Id_WebOrders		Int,
