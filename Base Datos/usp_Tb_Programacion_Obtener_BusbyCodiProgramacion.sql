GO
IF EXISTS (SELECT Top 1 1 FROM sys.objects WHERE type = 'P' AND name = 'usp_Tb_Programacion_Obtener_BusbyCodiProgramacion')
	BEGIN
		DROP PROCEDURE usp_Tb_Programacion_Obtener_BusbyCodiProgramacion
	End
GO
GO
Create Procedure usp_Tb_Programacion_Obtener_BusbyCodiProgramacion
