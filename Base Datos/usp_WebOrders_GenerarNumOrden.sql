GO
IF EXISTS (SELECT Top 1 1 FROM sys.objects WHERE type = 'P' AND name = 'usp_WebOrders_GenerarNumOrden')
	BEGIN
		DROP PROCEDURE usp_WebOrders_GenerarNumOrden
	End
GO
GO
Create Procedure usp_WebOrders_GenerarNumOrden
@IdCID			varchar(50),
@IdUser			numeric(18),
@UserIP			varchar(20),
@UserHost		varchar(50),
