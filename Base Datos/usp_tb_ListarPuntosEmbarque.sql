GO
IF EXISTS (SELECT Top 1 1 FROM sys.objects WHERE type = 'P' AND name = 'usp_tb_ListarPuntosEmbarque')
	BEGIN
		DROP PROCEDURE usp_tb_ListarPuntosEmbarque
	End
GO
GO
Create procedure usp_tb_ListarPuntosEmbarque    
@Ori int,      
@des int,      
@ser int,      
@emp int,      
...
begin      
SELECT DISTINCT      
 cod_paso as Codi_puntoVenta ,(select descripcion from tb_oficinas o where o.Codi_Sucursal=cod_paso) + '    HORA EMB. '+ hora_PASO  as PuntoVenta,
 hora_PASO,
